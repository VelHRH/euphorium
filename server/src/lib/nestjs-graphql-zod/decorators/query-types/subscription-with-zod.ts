/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/naming-convention, @typescript-eslint/no-unsafe-call, no-param-reassign, @typescript-eslint/no-unused-vars, @typescript-eslint/no-unsafe-argument, @typescript-eslint/strict-boolean-expressions */
...
export interface SubscriptionOptions<T extends AnyZodObject>
  extends Omit<SO, 'nullable' | 'defaultValue'> {
  /**
   * Default value.
   */
  defaultValue?: T;
